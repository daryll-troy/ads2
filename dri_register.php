...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (
        ...
        $sql = "INSERT INTO drivers (email_add, dri_username, password, fname, mname, lname,
        ...
        echo "_err variables are the culprit";
        // Close statement
        mysqli_stmt_close($stmt);
    }
    echo "'Request Method' if clause is the problem";
    // Close connection
    mysqli_close($link);
