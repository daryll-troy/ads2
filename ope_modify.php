...
if (isset($_POST["username"]) && !empty($_POST["username"])) {
    // Get WHERE condition input value
    $where = $_GET["dri_username"];
    ...
    if (
        ...
        $sql = "UPDATE drivers SET email_add=?, dri_username=?, password=?, fname=?, mname=?, lname=?, contactno=?, 
    ...
    if (isset($_GET["dri_username"]) && !empty(trim($_GET["dri_username"]))) {
        // Get URL parameter
        $username =  trim($_GET["dri_username"]);
