                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                     ...
                                     echo "<td>" . $row['fname'] . " " . $row['mname'] . " " . $row['lname'] . "</td>";
                                      ...
                                      echo "<td>" . $row['bday'] . "</td>";
                                       echo "<td>";
                                            echo '<a href="dri_read_self.php?dri_username='. $row['dri_username'] .'" class="mr-3" title="View Credentials" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                            echo '<a href="#?dri_username='. $row['dri_username'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
